...
package struct AudioDevice: Identifiable, Hashable, Sendable {
    package let id: AudioDeviceID
    ...
    package enum TransportType: Sendable, Hashable {
    ...
    package var transportType: TransportType {
    ...
    package static func find(uid: String) throws -> AudioDevice? {
