...
enum DriverInstaller {
    static let bundleID = "com.mixanimo.driver"
    static let installedPath = "/Library/Audio/Plug-Ins/HAL/Mixanimo.driver"
    ...
    static var bundledURL: URL? {
        Bundle.main.resourceURL?.appendingPathComponent("Mixanimo.driver")
    }
