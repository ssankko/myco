...
func makeNoise(frames: Int, channels: Int = 2, seed: UInt64 = 12345) -> [Float] {
...
func rms(_ samples: [Float], channel: Int = 0, channels: Int = 2, range: Range<Int>) -> Double {
    var sum = 0.0
    for frame in range {
...
func decibels(_ ratio: Double) -> Double {
